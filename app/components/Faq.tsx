...
const items = [
  {
    ...
    answer:
      "Quibusdam incidunt, corporis impedit quia id ab ipsam obcaecati neque rem animi reprehenderit laudantium accusantium enim sequi voluptas temporibus eaque accusamus sit",
  },
  {
    question: "Lorem ipsum dolor sit amet consectetur adipisicing elit?",
    answer:
...
export function Faq() {
  return (
    <div className="flex flex-col w-full py-[36px] lg:py-[24px] lg:flex-row lg:gap-x-6">
      <div className="lg:w1/3 lg:py-[32px] lg:pr-[56px]">
        ...
        <p className="text-[#36485C] pb-[24px]">
          ...
          eiusmod tempor incididunt ut labroe
        </p>
      </div>
            ...
            <div key={index}>
              ...
              >
                ...
                <Accordion.Trigger className="flex w-full items-center justify-between">
                    ...
                    <span><Image src={Plus} alt="see more" className="h-10 w-10 lg:h-6 lg:w-6"/></span>
                </Accordion.Trigger>
                </Accordion.Header>
